...
abstract class $SettingsModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(1, defaultValue: '') String token});
}
...
class _$SettingsModelImpl implements _SettingsModel {
  const _$SettingsModelImpl(
      ...
      @HiveField(1, defaultValue: '') this.token = ''});
  ...
  @override
  String toString() {
    return 'SettingsModel(isLoggedIn: $isLoggedIn, token: $token)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, isLoggedIn, token);
...
abstract class _SettingsModel implements SettingsModel {
  const factory _SettingsModel(
          ...
          @HiveField(1, defaultValue: '') final String token}) =
      _$SettingsModelImpl;
